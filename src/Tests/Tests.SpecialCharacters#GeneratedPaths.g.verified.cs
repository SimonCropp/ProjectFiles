...
{
    /// <summary>
    /// File extensions for 'file.with.dots'.
    /// </summary>
    public static class FileWithDots
    {
        /// <summary>
        /// PathNode for 'file.with.dots.txt'.
        /// </summary>
        public static PathNode Txt => new PathNode("file.with.dots.txt");

    }

    /// <summary>
    /// File extensions for 'my-config'.
    /// </summary>
    public static class MyConfig
    {
        /// <summary>
        /// PathNode for 'my-config.json'.
        /// </summary>
        public static PathNode Json => new PathNode("my-config.json");

    }

    /// <summary>
    /// File extensions for 'user_data'.
    /// </summary>
    public static class User_data
    {
        /// <summary>
        /// PathNode for 'user_data.csv'.
        /// </summary>
        public static PathNode Csv => new PathNode("user_data.csv");
