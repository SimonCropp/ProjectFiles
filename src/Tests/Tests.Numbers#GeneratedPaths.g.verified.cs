...
{
    /// <summary>
    /// File extensions for '1-first'.
    /// </summary>
    public static class _1First
    {
        /// <summary>
        /// PathNode for '1-first.txt'.
        /// </summary>
        public static PathNode Txt => new PathNode("1-first.txt");

    }

    /// <summary>
    /// File extensions for 'file123'.
    /// </summary>
    public static class File123
    {
        /// <summary>
        /// PathNode for 'file123.json'.
        /// </summary>
        public static PathNode Json => new PathNode("file123.json");
